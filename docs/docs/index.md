...
myst:
  html_meta:
    "description": "A chatbot addon for Agid Plone sites"
    "property=og:description": "A chatbot addon for Agid Plone sites"
    "property=og:title": "Design Plone Chatbot"
    "keywords": "Design Plone Chatbot, documentation, A chatbot addon for Agid Plone sites"
---

# Design Plone Chatbot

Welcome to the documentation for Design Plone Chatbot!
